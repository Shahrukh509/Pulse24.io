...
<div class="row">
            ...
            <div class="card gradient-2">
                <div class="card-body">
                    ...
                    <div class="d-inline-block">
                        <h2 class="text-white"><?php echo e($pending); ?></h2>
                                <p class="text-white mb-0"><?php echo e(\Carbon\Carbon::now()->format('d-M-y')); ?></p>
        ...
        <div class="col-lg-4 col-sm-12">
            <div class="card gradient-2">
                <div class="card-body">
                    ...
                    <div class="d-inline-block">
                        <h2 class="text-white"><?php echo e($active); ?></h2>
                        <p class="text-white mb-0"><?php echo e(\Carbon\Carbon::now()->format('d-M-y')); ?></p>
        ...
        <div class="col-lg-4 col-sm-12">
            <div class="card gradient-2">
                <div class="card-body">
                    ...
                    <div class="d-inline-block">
                        <h2 class="text-white"><?php echo e($all); ?></h2>
                        <p class="text-white mb-0"><?php echo e(\Carbon\Carbon::now()->format('d-M-y')); ?></p>
    ...
    <div class="row">
            ...
            <a href="<?php echo e(url('assigned')); ?>"><i class="fa fa-hand-pointer-o" aria-hidden="true"></i></a>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="card gradient-2">
                                <div class="card-body">
                                    ...
                                    <div class="d-inline-block">
                                        <h2>
            <a href="<?php echo e(url('history')); ?>"><i class="fa fa-hand-pointer-o" aria-hidden="true"></i></a>
            </h2> </div> <span class="float-right display-5 opacity-5"><i class="fa fa-bullhorn" aria-hidden="true"></i></span> </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="card gradient-2">
                                <div class="card-body">
                                    ...
                                    <div class="d-inline-block">
                                        <h2>
            <a href="<?php echo e(url('hierarchy')); ?>"><i class="fa fa-hand-pointer-o" aria-hidden="true"></i></a>
            </h2> </div> <span class="float-right display-5 opacity-5"><i class="fa fa-bullhorn" aria-hidden="true"></i></span> </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="card gradient-2">
                                <div class="card-body">
                                    ...
                                    <div class="d-inline-block">
                                        <h2>
            <a href="<?php echo e(url('upload')); ?>"><i class="fa fa-hand-pointer-o" aria-hidden="true"></i></a>
            </h2> </div> <span class="float-right display-5 opacity-5"><i class="fa fa-bullhorn" aria-hidden="true"></i></span> </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-4 col-sm-12">
            <div class="card gradient-2">
                <div class="card-body">
                    ...
                    <div class="d-inline-block">
                        <h2 class="text-white"><?php echo e($process_leads); ?></h2>
                                <p class="text-white mb-0"><?php echo e(\Carbon\Carbon::now()->format('d-M-y')); ?></p>
                            </div> <span class="float-right display-5 opacity-5">
        <i class="fa fa-bullhorn"></i>
        <i class="fa fa-spinner" aria-hidden="true"></i> </span> </div>
        ...
        <div class="col-lg-4 col-sm-12">
            <div class="card gradient-2">
                <div class="card-body">
                    ...
                    <div class="d-inline-block">
                        <h2 class="text-white"><?php echo e($total_emp); ?></h2>
                        <p class="text-white mb-0"><?php echo e(\Carbon\Carbon::now()->format('d-M-y')); ?></p>
                    </div> <span class="float-right display-5 opacity-5"><i class="fa fa-users"></i></span> </div>
            </div>
        </div>
        <div class="col-lg-4 col-sm-12">
            <div class="card gradient-2">
                <div class="card-body">
                    ...
                    <div class="d-inline-block">
                        <h2 class="text-white"><?php echo e($total_leads); ?></h2>
                        <p class="text-white mb-0"><?php echo e(\Carbon\Carbon::now()->format('d-M-y')); ?></p>
                    </div> <span class="float-right display-5 opacity-5"><i class="fa fa-bullhorn" aria-hidden="true"></i></span> </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\axconnect\resources\views/dashboard.blade.php ENDPATH**/ ?>