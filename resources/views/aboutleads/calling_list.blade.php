<table id="example" class="table table-striped" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="" button type="button" calling-remarks="{{ $data->remarks }}"  class="fa fa-eye btn btn-primary calling-edit"  data-toggle="modal" data-target="#callingymodal"> view</a></td>
                </tr>
                @endforeach
