                ...
                <li class="icons dropdown">
                    ...
                    <div class="drop-down animated fadeIn dropdown-menu dropdown-notfication">
                        <div class="dropdown-content-heading d-flex justify-content-between">
                            <span class="">{{ $count }} New Notifications</span>
                                ...
                                <li>
                                    <a href="javascript:void()" notif_id="{{ $notif->id }}" >
                                        ...
                                        <div class="notification-content">
                                            ...
                                            <span class="notification-text"> {{ \Carbon\Carbon::parse($notif->created_at)->format('d/m/Y') }} </span>
                                            <a href="{{ route('read',$notif->id) }}">Mark as Read</a>
                                        </div>
                                    </a>
                                </li>
                                @endforeach
