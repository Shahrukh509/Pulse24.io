...
<form id="form"class="row g-3 " method="post" action="{{url('create/users')}}" enctype="multipart/form-data">

    @csrf

    <div class="col-md-4 position-relative">
        <label for="validationTooltip01" class="form-label">Employee Name<span class="important-star">*</span></label>
        <input type="text" class="form-control" id="employee_name" name="name" value="{{ old('name') }}" required>

    </div>
    <div class="col-md-4 position-relative">
        <label for="validationTooltip02" class="form-label">Email<span class="important-star">*</span></label>
        <input type="email" class="form-control" id="employee_email" name="email" value="{{ old('email') }}" required>
    ...
    <div class="col-md-4 position-relative">
        <label for="validationTooltipUsername" class="form-label">Phone Number<span class="important-star">*</span></label>
            ...
            <input type="tel" name="phone" class="form-control" id="employee_number" value="{{ old('phone') }}" required>
    ...
    <div class="col-md-4 position-relative">
        ...
        <select class="form-control" name="linemanager_id">
            ...
            <option value="{{ $manager->id }}"{{ old('linemanager_id') == $manager->id? 'selected':'' }}>
    ...
    <div class="col-md-4 position-relative">
        <label for="validationTooltip01" class="form-label"> Username</label><span class="important-star">*</span>
        <input type="text" name="username" class="form-control" id="employee_username" value="{{ old('username') }}" required>

    </div>
    <div class="col-md-4 position-relative">
        <label for="validationTooltip02" class="form-label">Password</label>
        <input type="password" name="password" class="form-control" id="employee_password" value="" required>
